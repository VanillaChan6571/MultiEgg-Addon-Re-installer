        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="alert alert-warning">
                    Your addon is outdated! Please update it as soon as you can! You are on version {{ $global_settings->current_version }}, and the latest is {{ $global_settings->latest_version }}.
                </div>
            </div>
        </div>
    @endif
@endsection
root@extronode:~# cat /var/www/pterodactyl/resources/views/admin/multiegg/index.blade.php
use app\Http\Controllers\MultiEggController;
